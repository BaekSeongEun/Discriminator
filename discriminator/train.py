...
# path 직접 지정
real_image_paths = [f'/home/tjddms9376/cv/data/real/{x}.png' for x in range(4,11)]
fake_image_paths = [f'/home/tjddms9376/cv/data/fake/{x}.png' for x in range(4,11)]
...
torch.save(discriminator.state_dict(), f'/home/tjddms9376/cv/discriminator/pretrained/model_latest.pth')
