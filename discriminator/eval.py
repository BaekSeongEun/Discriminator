...
real_artwork = load_image('/home/tjddms9376/cv/data/Vincent_van_Gogh/Vincent_van_Gogh_739.jpg').unsqueeze(0)  # Add batch dimension
generated_artwork = load_image('/home/tjddms9376/cv/test/7.png').unsqueeze(0)
...
loaded_model.load_state_dict(torch.load('/home/tjddms9376/cv/discriminator/pretrained/model_4000_gogh.pth'))
loaded_model.eval()  
